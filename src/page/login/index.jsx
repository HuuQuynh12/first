      ...
      <div className="flex items-center justify-center h-screen">
        <div className="min-w-fit flex-col border bg-white px-6 py-14 shadow-md rounded-[4px] ">
          <div className="mb-8 flex justify-center">
            <img
              className="w-24"
              src="https://banner2.cleanpng.com/20190525/rfb/kisspng-button-computer-icons-login-image-illustration-index-of-images-5ce952d5a81805.2893926115587949656885.jpg"
              alt=""
            />
          </div>
          ...
          <button
            className="mt-5 w-full border p-2 bg-gradient-to-r bg-red-400 text-white rounded-[4px] hover:bg-slate-400 scale-105 duration-300"
            onClick={handleLogin}
          >
            Sign in
          </button>
